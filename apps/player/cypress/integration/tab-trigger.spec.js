...
describe('<tab-trigger>', () => {
  ...
  describe('chapters', () => {
    ...
    it('should emit toggle tab when clicked', function (done) {
      cy.bootstrap('<tab-trigger tab="chapters">inner</tab-trigger>', [this.chapters]).then(
        (app) => {
  ...
  describe('transcripts', () => {
    ...
    it('should emit toggle tab when clicked', function (done) {
      cy.bootstrap('<tab-trigger tab="transcripts">inner</tab-trigger>', [this.transcripts]).then(
        (app) => {
          onUpdate(app, 'PLAYER_TOGGLE_TAB', (_, { payload }) => {
  ...
  describe('playlist', () => {
    ...
    it('should emit toggle tab when clicked', function (done) {
      cy.bootstrap('<tab-trigger tab="playlist">inner</tab-trigger>', [this.playlist]).then(
        (app) => {
          onUpdate(app, 'PLAYER_TOGGLE_TAB', (_, { payload }) => {
