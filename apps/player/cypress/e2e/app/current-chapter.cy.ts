...
describe('<current-chapter>', () => {
  ...
  describe('logic', () => {
    ...
    it('should show the chapter last chapter', (done) => {
      cy.app('<current-chapter></current-chapter>', [chapters]).then((store) => {
