...
describe('<chapter-previous>', () => {
  describe('render', () => {
    it('should not render when chapters are not available', () => {
      cy.app('<chapter-previous></chapter-previous>').then(() => {
        cy.query('chapter-previous').should('not.exist');
      });
    });

    it('should render when chapters are available', () => {
      cy.app('<chapter-previous></chapter-previous>', [chapters]).then(() => {
  ...
  describe('logic', () => {
    ...
    beforeEach(() =>
      cy.app('<chapter-previous></chapter-previous>', [chapters]).then((app) => {
