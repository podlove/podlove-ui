    ...
    <g>
      <g transform="translate(2.000000, -9.000000)">
        <g transform="translate(0.000000, 10.000000)">
          <path :fill="color" d="M32.3,14.9c0-7.3-6-13.3-13.3-13.3C12.5,1.7,6.8,6.5,5.9,13l-0.1,0.9H2.7l4.1,5.5l4.1-5.5H7.8l0.2-1.2
            c1.1-5.2,5.7-9,11-9c6.2,0,11.2,5,11.2,11.2c0,5.8-4.5,10.6-10.2,11.2v2.1C26.9,27.7,32.3,21.9,32.3,14.9z"/>
          <g>
            <path :fill="color" d="M17.2,19.5h-1.4v-7.2H14v-1l3.2-0.3V19.5z M18.7,15.7l0.5-4.7h4.5v1.2h-3.3l-0.3,2.1
