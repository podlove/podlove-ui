...
export interface LocationParameters { starttime?: number | undefined, stoptime?: number | undefined, episode?: string, config?: string, autoplay?: boolean }

export const locationParams = (): ParsedQuery => queryString.parse(window.location.search)

const parseParameters = (parameters: { t?: string, episode?: string, config: string, autoplay: string }) => {
...
export const urlParameters = compose<any[], ParsedQuery, LocationParameters>(parseParameters, locationParams)
